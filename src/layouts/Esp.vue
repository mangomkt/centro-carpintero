<template>
  <div class="content-wrapper font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    ...
    <ClientOnly>
      ...
      >
        <p slot="header">Contacta a Martha hoy para recibir una cotización gratuita para tu próximo proyecto.</p>
        ...
        <small slot="footer">Disponible de lunes a sábado de 8 a 18 h.</small>
      </SocialChat>
    </ClientOnly>
  </div>
</template>
