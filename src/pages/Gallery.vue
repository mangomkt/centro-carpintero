<template>
  <Layout>
    ...
    <div class="text-4xl py-8 text-black font-light leading-tight" style="text-align:center">Kitchens</div>
    <div class="container-inner mx-auto py-50">
      ...
      <div class="flex flex-wrap justify-between items-center py-6">
        ...
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../static/gallery/modern-kitchen.jpg" alt="Modern Kitchen Look" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Modern Kitchen Look</div>
          </div>
          <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
      ...
      <div class="flex flex-wrap justify-between items-center py-6">
        ...
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../static/gallery/bed-frame.jpg" alt="Wood Bed Frame" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Wood Bed Frame</div>
        </div>
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
...
<div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
      ...
      <h2 class="text-4xl text-Black font-light leading-tight" style="text-align:center">Custom Wood</h2>
      <div class="flex flex-wrap justify-between items-center py-6">
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
