    ...
    <div class="hero hero-nima-bay-projecto">
      <div class="container-inner mx-auto flex flex-col sm:flex-row justify-between py-20">
        <div class="w-full text-center sm:text-center">
          <h1 class="text-5xl font-serif font-light text-white leading-tight">Proyecto Nima Bay</h1>
      ...
      <div class="flex flex-wrap justify-between items-center py-6">
        <div class="w-full sm:w-1/2 px-8 py-8 sm:py-0 text-center">
         ...
         <div class="w-full sm:w-1/2 px-8 py-8 sm:py-0">
          <div class="text-4xl font-light leading-tight my-4">Proyecto Nima Bay</div>
          <p>La estructura y todas las puertas son de madera natural de Parota de 16mm de espesor</p>
          <p>Las encimeras son de Cuarzo Natural Mont Blanc que proviene de Brasil</p>
          <p>Todo el herraje es oculto, de extracción total, y con mecanismo de autocierre</p>
        </div>
      </div>
    </div>
