<template>
  <Esp>
    ...
    <div class="container-inner mx-auto py-50">
      ...
      <div class="flex flex-wrap justify-between items-center py-6">
       ...
       <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../../static/gallery/RENOVATED-KITCHEN.jpg" alt="Remodelación de cocinas a medida" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Remodelación de cocinas a medida</div>
        </div>
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
        ...
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../../static/gallery/modern-kitchen.jpg" alt="Aspecto de cocina moderna" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Aspecto de cocina moderna</div>
          </div>
          <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
        ...
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../../static/gallery/RENOVATED-NEW-BAR.jpg" alt="Barra personalizada" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Barra personalizada</div>
        </div>
      </div>
      <h2 class="text-4xl text-Black font-light leading-tight" style="text-align:center">Dormitorios y Baños</h2>
      <div class="flex flex-wrap justify-between items-center py-6">
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../../static/gallery/CUSTOM-WOOD-BED-FRAME.jpg" alt="Marco de cama para carpintería personalizado" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Marco de cama para carpintería personalizado</div>
        </div>
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../../static/gallery/UPDATED-BEDROOM-CLOSETS.jpg" alt="Armarios renovados en las habitaciones" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Armarios renovados en las habitaciones</div>
        </div>
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
        ...
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../../static/gallery/bed-frame.jpg" alt="Marco de cama de madera" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Marco de cama de madera</div>
        </div>
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../../static/gallery/RENOVATED-BATHROOM-TILES.jpg" alt="Azulejos De Pared De Baño" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Azulejos De Pared De Baño</div>
        </div>
        ...
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../../static/gallery/modern-bathroom.jpg" alt="Aspecto de baño moderno" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Aspecto de baño moderno</div>
        </div>
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
      ...
      <div class="flex flex-wrap justify-between items-center py-6">
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../../static/gallery/MAKEUP.jpg" alt="Escritorio / tocador de madera hermoso del maquillaje" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Escritorio / tocador de madera hermoso del maquillaje</div>
        </div>
        ...
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../../static/gallery/custom-wood-entertainment-system.jpg" alt="Sistema de entretenimiento de madera personalizado"/>
          <div class="text-green font-bold leading-tight mt-4 mb-8">Sistema de entretenimiento de madera personalizado</div>
        </div>
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../../static/gallery/desk.jpg" alt="Escritorio personalizado" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Escritorio personalizado</div>
        </div>

        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../../static/gallery/custom-shelfs-and-desk.jpg" alt="Estantes y escritorio personalizados" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Estantes y escritorio personalizados</div>
        </div>

        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
          <g-image src="../../../static/gallery/CUSTOM-WOOD-NIGHT-TABLES.jpg" alt="Mesas de noche de madera" />
          <div class="text-green font-bold leading-tight mt-4 mb-8">Mesas de noche de madera
           </div>
        </div>
        <div class="w-full lg:w-1/4 md:w-1/2 px-8 py-8 sm:py-0 text-center">
