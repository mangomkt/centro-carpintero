    ...
    <div class="container-inner mx-auto py-20">
      <div class="flex flex-wrap justify-between items-center py-6">
        ...
        <div class="w-full sm:w-1/2 px-8 py-8 sm:py-0">
          <div class="text-4xl font-light leading-tight my-4">Peninsula Project</div>
          <ul class="list-disc ml-6 mb-4">
          <li>Natural Mont Blanc quartz from Brazil was used on all kitchen counters.</li>
          <li>Throughout the bathrooms, Crema Marfil marble and Red Alicante marble were used.</li>
          <li>The bar top counter is Universal granite with a leather finish.</li>
          <li>Lupita Natural quartz was used for the kitchen backsplash and island walls.</li>
        </ul>
        </div>
      </div>
    </div>
